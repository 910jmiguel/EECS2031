...
int main(){
 ...
 // Define additional strings and assign them to the inputs array
  ...
  printf("\n== before swapping ==\n");
  printf("===========================\n");
  printParr(inputs, n); // sends the input arrays and size of array
...
// swap pointee of 3rd and 4th pointers
// swap pointee of 5th and 6th pointers
// if n is odd number then last pointee is not swapped
